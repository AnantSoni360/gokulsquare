...
export default function FloorTwo() {
  const floorSpaces = spacesData.filter(s => s.floor.includes("Second"));
  ...
  return (
    <div className="min-h-screen bg-light-gray pt-24 px-6 md:px-12">
      ...
      >
        <span className="text-almost-black/60 font-bold tracking-widest uppercase text-[14px]">Level 2</span>
        ...
        <p className="text-almost-black/80 text-[18px] max-w-2xl leading-relaxed">
          Professional. Modern. The corporate hub of Toranagallu. Built specifically for corporate leasing, tech startups, and professional services with acoustic insulation.
        </p>
      </motion.div>
